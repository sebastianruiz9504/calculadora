...
if($release.ScmBaseUrl -ne $scm -or $release.SubscriptionId -ne $subscription -or $release.BaselineDeploymentId -ne 'd0a493bedfcb4234ab679d8ea8222dc9' -or $release.Files.Count -ne 6 -or $release.ConfigurationChanges){throw 'Unapproved release manifest.'}
