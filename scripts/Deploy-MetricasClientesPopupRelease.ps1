...
if($release.ScmBaseUrl -ne $scm -or $release.SubscriptionId -ne $subscription -or $release.BaselineDeploymentId -ne 'ab93c7ab689a437596f6ada0f29da10d' -or $release.Files.Count -ne 9 -or $release.ConfigurationChanges){throw 'Unapproved release manifest.'}
