...
$baseline='de75b891ffa9fc23e4c69cc153e61038924ac1bf'
$deployment='c488553429a6466ea6e05a48b3ae8d5a'
$dllHash='63CED00B89A6AA5C88EBF07CDE37D421CF35BFB1F8AD27C0E0E925363AF08F8C'
$manifestHash='BA347121A9AA89C504A89A46116E9E38DD4D7D7099D33F727D6D7319C809CEA6'
...
$releaseRoot=Join-Path $ArtifactRoot ($commit.Substring(0,8)+'-conciliacion-contact-detail')
...
$assets=@('wwwroot/js/conciliacion.js','wwwroot/css/conciliacion.css')
$names=@('CotizadorInterno.Web.dll','CotizadorInterno.Web.pdb',$manifest)+@($assets|ForEach-Object{$_;"$_.br";"$_.gz"})
$newNames=@()
$preserved=@('appsettings.json','wwwroot/js/copiers-equipment-operations.js','wwwroot/js/copiers-mto-v2.js','web.config','CotizadorInterno.Web.deps.json','CotizadorInterno.Web.runtimeconfig.json','wwwroot/js/dashboard.js','wwwroot/js/support-cloud-surveys.js','wwwroot/js/copiers-mto-v2-picker.js','wwwroot/js/copiers-mto-v2-drafts.js','wwwroot/css/copiers-mto-v2.css')
...
if($replacement.Count -ne 20){throw 'Expected twenty JS/CSS endpoint variants.'}
