...
$baseline='e61ad7bdd400046a94e1e26b074157731e460792'
$deployment='f8548c51948e45d6a59b37988d0136fa'
$dllHash='C3C512777EA5FE20B08DB9CBE19D3F37ED423A780F72432572519F14997D5E83'
$manifestHash='48E42342F965BBD13427A7266610921C8EF2188AD101E9E8AD29DFA3F8226234'
...
$releaseRoot=Join-Path $ArtifactRoot ($commit.Substring(0,8)+'-copiers-unified')
...
$assets=@('wwwroot/js/copiers.js','wwwroot/js/copiers-mto-v2-calendar.js','wwwroot/js/dashboard.js')
$names=@('CotizadorInterno.Web.dll','CotizadorInterno.Web.pdb',$manifest)+@($assets|ForEach-Object{$_;"$_.br";"$_.gz"})
$newNames=@()
$preserved=@('wwwroot/js/metricas.js','wwwroot/css/metricas.css','wwwroot/js/puntajes.js','wwwroot/js/puntajes.js.br','wwwroot/js/puntajes.js.gz','wwwroot/js/copiers-mto-v2.js','appsettings.json','web.config','CotizadorInterno.Web.deps.json','CotizadorInterno.Web.runtimeconfig.json','wwwroot/js/support-cloud-surveys.js','wwwroot/js/copiers-mto-v2-picker.js','wwwroot/js/copiers-mto-v2-drafts.js','wwwroot/js/copiers-equipment-operations.js','wwwroot/css/copiers-equipment-operations.css','wwwroot/css/copiers-mto-v2.css')
...
if($replacement.Count -ne 30){throw 'Expected thirty Copiers asset endpoint variants.'}
