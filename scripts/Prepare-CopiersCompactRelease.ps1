...
$baseline='24d931f1abd5cf36f8ed5631465f52b9d3d3b66c'
$deployment='a9121dd876254332b5ab1ef332254b75'
$dllHash='9E4999CA098DE6B71EC14782034D0F82B294FC450710049FA113CCE3EBF8FEF1'
$manifestHash='4A70484972CA77DEE461A02A82AB779BC6B0827DB83178DB10898D5CB55EE233'
...
$releaseRoot=Join-Path $ArtifactRoot ($commit.Substring(0,8)+'-copiers-compact')
...
$assets=@('wwwroot/js/dashboard.js','wwwroot/css/dashboard.css')
$names=@($manifest)+@($assets|ForEach-Object{$_;"$_.br";"$_.gz"})
$newNames=@()
$preserved=@('CotizadorInterno.Web.dll','CotizadorInterno.Web.pdb','wwwroot/js/metricas.js','wwwroot/css/metricas.css','wwwroot/js/puntajes.js','wwwroot/js/puntajes.js.br','wwwroot/js/puntajes.js.gz','wwwroot/js/copiers-mto-v2.js','appsettings.json','web.config','CotizadorInterno.Web.deps.json','CotizadorInterno.Web.runtimeconfig.json','wwwroot/js/support-cloud-surveys.js','wwwroot/js/copiers-mto-v2-picker.js','wwwroot/js/copiers-mto-v2-drafts.js','wwwroot/js/copiers-mto-v2-calendar.js','wwwroot/js/copiers-mto-v2-calendar.js.br','wwwroot/js/copiers-mto-v2-calendar.js.gz','wwwroot/js/copiers-equipment-operations.js','wwwroot/css/copiers-equipment-operations.css','wwwroot/css/copiers-mto-v2.css')
...
if($replacement.Count -ne 20){throw 'Expected twenty dashboard asset endpoint variants.'}
