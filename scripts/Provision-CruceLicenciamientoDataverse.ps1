param(
    ...
    [string]$SchemaPath = "$PSScriptRoot\cruce-licenciamiento-dataverse-schema.json",
...
$baseScript = Join-Path $PSScriptRoot "Provision-SoporteCloudEncuestasDataverse.ps1"
if (-not (Test-Path -LiteralPath $baseScript)) {
    throw "No se encontro el script base de provisionamiento: $baseScript"
}
...
Write-Host "Provision de Cruce Licenciamiento finalizado." -ForegroundColor Green
