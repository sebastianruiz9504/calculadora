...
$baseline='0a077e8579ad12446497922459d9128711b09565'
$deployment='ab93c7ab689a437596f6ada0f29da10d'
$dllHash='91012F9CEA2C662D0CF4F77DDF7ECA0CC62B88882236643827398EE4D3273D1E'
$manifestHash='D76C44047B6040BD070E3648966228CA56D504B253B13F4539258CE6B97FC465'
...
$releaseRoot=Join-Path $ArtifactRoot ($commit.Substring(0,8)+'-metricas-clientes-popup')
...
if($replacement.Count -ne 20){throw 'Expected twenty metrics asset endpoint variants.'}
