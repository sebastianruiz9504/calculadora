...
public sealed class RhAccessFilter : IAsyncActionFilter
{
    public const string CurrentUserItemKey = "RH.CurrentUser";

    private readonly IDataverseService _dataverse;

    public RhAccessFilter(IDataverseService dataverse)
    {
